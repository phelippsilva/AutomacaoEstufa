...
linker.cmd: package/cfg/empty_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/empty_pem4fcfg.cmd\)\"$""\"C:/Users/Tiago/Documents/GitHub/AutomacaoEstufa/Workspace_CCS/central_Estufa/.config/xconfig_empty/\1\""' package/cfg/empty_pem4f.xdl > $@
