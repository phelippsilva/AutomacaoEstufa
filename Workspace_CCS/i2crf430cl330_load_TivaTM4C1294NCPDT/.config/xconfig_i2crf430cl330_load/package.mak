...
override PKGDIR = xconfig_i2crf430cl330_load
...
package/%.xdc.inc package/%_xconfig_i2crf430cl330_load.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_i2crf430cl330_load" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: i2crf430cl330_load.pem4f

-include package/cfg/i2crf430cl330_load_pem4f.mak
-include package/cfg/i2crf430cl330_load_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/i2crf430cl330_load_pem4f.dep
endif
i2crf430cl330_load.pem4f: package/cfg/i2crf430cl330_load_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
i2crf430cl330_load.pem4f package/cfg/i2crf430cl330_load_pem4f.c: .libraries,em4f
endif

package/cfg/i2crf430cl330_load_pem4f.c package/cfg/i2crf430cl330_load_pem4f.h package/cfg/i2crf430cl330_load_pem4f.xdl: override _PROG_NAME := i2crf430cl330_load.xem4f
package/cfg/i2crf430cl330_load_pem4f.c: package/cfg/i2crf430cl330_load_pem4f.cfg

clean:: clean,em4f
	-$(RM) package/cfg/i2crf430cl330_load_pem4f.cfg
	-$(RM) package/cfg/i2crf430cl330_load_pem4f.dep
	-$(RM) package/cfg/i2crf430cl330_load_pem4f.c
	-$(RM) package/cfg/i2crf430cl330_load_pem4f.xdc.inc

clean,em4f::
	-$(RM) i2crf430cl330_load.pem4f
.executables,em4f .executables: i2crf430cl330_load.xem4f

i2crf430cl330_load.xem4f: |i2crf430cl330_load.pem4f

-include package/cfg/i2crf430cl330_load.xem4f.mak
i2crf430cl330_load.xem4f: package/cfg/i2crf430cl330_load_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armlnk -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@).  -q -o $@ package/cfg/i2crf430cl330_load_pem4f.oem4f   package/cfg/i2crf430cl330_load_pem4f.xdl --silicon_version=7M4 --strict_compatibility=on -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
i2crf430cl330_load.xem4f: export C_DIR=
i2crf430cl330_load.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
i2crf430cl330_load.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

i2crf430cl330_load.test test,em4f test: i2crf430cl330_load.xem4f.test

i2crf430cl330_load.xem4f.test:: i2crf430cl330_load.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 i2crf430cl330_load.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.i2crf430cl330_load.xem4f, ) 
endif

clean,em4f::
	-$(RM) .tmp,i2crf430cl330_load.xem4f,0,*


clean:: clean,em4f

clean,em4f::
	-$(RM) i2crf430cl330_load.xem4f
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
i2crf430cl330_load_pem4f.oem4f,copy : package/cfg/i2crf430cl330_load_pem4f.oem4f
i2crf430cl330_load_pem4f.sem4f,copy : package/cfg/i2crf430cl330_load_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg .interfaces $(XDCROOT)/packages/xdc/cfg/Main.xs
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_i2crf430cl330_load
xconfig_i2crf430cl330_load.tar: package/package.bld.xml
xconfig_i2crf430cl330_load.tar: package/build.cfg
xconfig_i2crf430cl330_load.tar: package/package.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_i2crf430cl330_load.tar.dep
endif
package/rel/xconfig_i2crf430cl330_load/xconfig_i2crf430cl330_load/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_i2crf430cl330_load.tar: package/rel/xconfig_i2crf430cl330_load.xdc.inc package/rel/xconfig_i2crf430cl330_load/xconfig_i2crf430cl330_load/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_i2crf430cl330_load.xdc.inc,package/rel/xconfig_i2crf430cl330_load.tar.dep)


release release,xconfig_i2crf430cl330_load: all xconfig_i2crf430cl330_load.tar
clean:: .clean
	-$(RM) xconfig_i2crf430cl330_load.tar
	-$(RM) package/rel/xconfig_i2crf430cl330_load.xdc.inc
	-$(RM) package/rel/xconfig_i2crf430cl330_load.tar.dep
